...
object CreateGatewayWalletFlow {
    /**
    ...
    class Initiator(private val wallet: Wallet) : FlowLogic<SignedTransaction>() {
        ...
        companion object {
            ...
            object FLOW_SESSION: ProgressTracker.Step("Initiation flow session with workflows party")
        ...
        override fun call(): SignedTransaction {
            ...
            progressTracker.currentStep =
                    FLOW_SESSION
            // initiate session with workflows party and send proposed wallet data
            ...
            val signTransactionFlow = object : SignTransactionFlow(gatewaySession,
    ...
    class Responder(private val issuerSession: FlowSession) : FlowLogic<SignedTransaction>() {
        ...
        @Suspendable
        override fun call(): SignedTransaction {
            //there is a prerecorded list of issuers that this workflows recognises
